                ...
                with sales as (
                    ...
                    from
                     (
                        ...
                        0 as return_qty,
                        sum(round((price_subtotal/(CASE sale_order_line.product_uom_qty WHEN 0 Then 1 ELSE sale_order_line.product_uom_qty END)),2)) as sale_price_unit,
                        ...
                        sum(product_qty) as delivered_qty,
                        0 as return_qty,
                        sum(round((price_subtotal/(CASE pos_order_line.qty WHEN 0 Then 1 ELSE pos_order_line.qty END)),2)) as sale_price_unit,                    
                        0 as return_price_unit,
                        sum(abs(stock_move.price_unit)) as sale_cost ,
                        0 as return_cost
                        from stock_move 
                        ...
                        sum(round((price_subtotal/(CASE sale_order_line.product_uom_qty WHEN 0 Then 1 ELSE sale_order_line.product_uom_qty END)),2)) as return_price_unit,
                        0 as sale_cost,
                        ...
                        sum(product_qty) as return_qty,
                        0 as sale_price_unit,
                        sum(round((price_subtotal/(CASE pos_order_line.qty WHEN 0 Then 1 ELSE pos_order_line.qty END)),2)) as return_price_unit,
                        0 as sale_cost,
                        sum(abs(stock_move.price_unit)) as return_cost
                        from stock_move 
                        inner join stock_location on stock_location.id=stock_move.location_id and stock_location.usage='customer'
